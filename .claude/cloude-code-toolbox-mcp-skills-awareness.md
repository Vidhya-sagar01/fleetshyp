...
_Generated: 2026-05-17T13:43:52.346Z_
...
Workspace `mcp.json` _(folder: fleetshyp)_

- **c:\Users\Vidhya Sagar\Downloads\fleetshyp\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Vidhya Sagar\.claude.json** — _File missing_
